...
public class ClientRepositoryImpl implements ClientRepository {
    ...
    private static final String ADD_NEW_CLIENT = "INSERT INTO \"tire\".clients (first_name, midl_name, last_name, date_of_birth, phone_number) VALUES (?,?,?,?,?)";
    private static final String DELETE_CLIENT_BY_ID = "DELETE FROM \"tire\".clients c where c.id=?";
    private static final String SET_PHONE_NUMBER_CLIENT_BY_ID = "UPDATE \"tire\".clients c SET phone_number=? WHERE c.id=?";
