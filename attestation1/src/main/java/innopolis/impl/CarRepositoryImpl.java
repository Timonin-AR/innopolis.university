...
import innopolis.CarRepository;
...
public class CarRepositoryImpl implements CarRepository {
    ...
    private static final String ADD_NEW_CAR = "INSERT INTO \"tire\".cars (client_id, car_name, car_model, car_number) VALUES (?,?,?,?)";
    private static final String DELETE_CAR = "DELETE FROM \"tire\".cars c where c.id=?";
    private static final String SET_CAR_NUMBER = "UPDATE \"tire\".cars c SET car_number=? WHERE c.id=?";
